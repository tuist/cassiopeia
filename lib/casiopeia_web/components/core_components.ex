defmodule CasiopeiaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CasiopeiaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CasiopeiaWeb.Gettext, "errors", msg, opts)
    end
  end
